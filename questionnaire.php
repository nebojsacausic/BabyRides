...
<!-- Register page content -->
        ...
        ?>
				...
				<!-- Start registration -->
				<section class="shop registration section questionnaire-form">
					<div class="container">
						<div class="row"> 
                                            ...
                                            if(!$is_vote){
                                                ...
                                                $content = '<div id="questionnaire-area">
                                                                <form action="views/questionnaireCrud.php" method="POST">
                                                                    <h3>'.$resultQuestion->question.'</h3><div class="response-group">';
                                                ...
                                                $content.='
                                                                </div>    <input type="submit" class="btn" name="questionnaire_submit" id="questionnaire_submit">
                                                                </form>
                                                            </div>';
                                                echo $content;
                                            }
